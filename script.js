...
const data = {
    ...
    "projects": [
        ...
        },
        {
            ...
            "description": "</br><strong>Monthly Performance Dashboard:</strong> </br>This dashboard shows monthly performance of different product categories. By visualizing trends, highlighting high-performing categories and monthly growth, it helps decision-makers to make data-driven decisions. Key features include dynamic filters, trend analysis, and year-to-date comparisons. </br></br><strong>Inventory vs Sales Dashboard:</strong></br> The Inventory vs Sales dashboard helps in balancing between stock levels and sales performance. It highlights understocked or overstocked products and identifies items with low sales velocity. This enables better inventory planning, reduces holding costs, and minimizes lost sales opportunities. The dashboard includes visual cues for critical stock alerts, sales-to-inventory ratios, and actionable insights. </br></br> <strong>Company Sales Dashboard:</strong> </br> This dashboard focuses on analyzing sales distribution by company or client. It provides a breakdown of which companies purchased which products, the volume of sales, and purchasing trends over time and monitoring their buying patterns.</br></br> <strong>Price Analysis Dashboard:</strong> </br> This dashboard focuses on product-level pricing analysis, identifying overpricing and underpricing to maintain competitiveness in the market against competitors. It also provides real-time updates and notifications when critical pricing changes occur.</br></br> <strong>Trend Analysis Dashboard:</strong> </br> The Trend Analysis Dashboard provides insights into which criteria are trending in the current month while maintaining historical trends from previous months. These insights help predict upcoming trends and enable proactive planning and control of production and sales.</br></br> <strong>Company Analysis Dashboard:</strong> </br> This dashboard analyses the company’s production capacity alongside year-by-year sales performance across different companies. It helps forecast optimal inventory levels and ensures the organization is well-prepared to meet upcoming orders efficiently.</br></br> <strong>Target & Inventory Analysis Dashboard:</strong> </br> This dashboard analyzes buyer demand and targets alongside inventory control to prevent overstocking and understocking. It also supports safe and efficient production planning by aligning output with market and buyer demand."
        }
    ],
    "companies": [
        {
